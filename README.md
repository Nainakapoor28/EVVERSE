EVVerse – Smart EV Charging Recommendation System

EVVerse is a machine learning–based web application designed to help electric vehicle (EV) users locate the nearest EV charging stations in India. The system uses geospatial analysis and K-Nearest Neighbors (KNN) to provide accurate, distance-based charging station recommendations through an interactive and user-friendly interface.

Project Overview

With the rapid adoption of electric vehicles, EV users often face range anxiety due to scattered and unreliable charging infrastructure information. EVVerse addresses this problem by offering a centralized, intelligent, and easy-to-use platform that recommends nearby charging stations based on user location.
This project was developed as a Minor Project for the Bachelor of Computer Applications (BCA) program.
